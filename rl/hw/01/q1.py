...
if __name__ == '__main__':
    ...
    ax.plot(trials, np.mean(r1, axis=0),
            color='r', label=Q1.label)

    ax.plot(trials, np.mean(r2, axis=0),
            color='b', label=Q2.label)

    ax.plot(trials, np.mean(r3, axis=0),
            color='r', label=Q3.label, linestyle='dashed')

    ax.plot(trials, np.mean(r4, axis=0),
            color='b', label=Q4.label, linestyle='dashed')

    ax.plot(trials, np.mean(r5, axis=0),
